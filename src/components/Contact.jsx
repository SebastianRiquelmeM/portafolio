          ...
          >
            <div>
              ...
              <p className="mt-2 text-base text-gray-600 dark:text-gray-300">
                Estoy disponible para trabajar en proyectos remotos o presenciales en Santiago de Chile.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-indigo-600 dark:text-indigo-400">
                <a href="mailto:riquelmemunozsebastian@gmail.com" className="hover:underline">
            ...
            <div>
              <h4 className="text-base font-semibold text-gray-900 dark:text-white">Teléfono</h4>
              <p className="mt-1 text-indigo-600 dark:text-indigo-400">
                <a href="tel:+56950438455" className="hover:underline">
                  +56 9 5043 8455
                </a>
              </p>
            </div>
            ...
            <div>
              <h4 className="text-base font-semibold text-gray-900 dark:text-white">Redes Sociales</h4>
              <div className="mt-3 flex space-x-6">
                <a href="https://www.linkedin.com/in/sebastián-riquelme-566a16261/" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">
                  <span className="sr-only">LinkedIn</span>
                  <ion-icon name="logo-linkedin" class="text-2xl"></ion-icon>
                </a>
                <a href="https://github.com/SebastianRiquelmeM" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">

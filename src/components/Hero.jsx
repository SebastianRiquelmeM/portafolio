			...
			>
				<div className="text-center space-y-4">
					<motion.div className="relative inline-block">
						...
						>
							Hola <span className="inline-block animate-bounce">👋</span>, soy
						</motion.h5>
						{/* La estrella animada ha sido eliminada */}
					</motion.div>
					...
					>
						Transformo procesos manuales en sistemas digitales escalables que optimizan operaciones y aumentan rentabilidad.
					</motion.p>
				</div>

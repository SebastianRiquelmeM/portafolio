	...
	const techCategories = [
		...
		},
		{
			...
			skills: [
				...
				{ name: "REST APIs", icon: "devicon-fastapi-plain colored" }, // No hay ícono específico para RESTful APIs
				{ name: "OAuth 2.0", icon: "devicon-google-plain colored" }, // No hay ícono específico para OAuth
			],
		},
		{
			...
			skills: [
				...
				{ name: "SQL", icon: "devicon-azuresqldatabase-plain colored" }, // Usando SQLite como representación de SQL
		...
		},
		{
			...
			skills: [
				...
				{ name: "CI/CD", icon: "devicon-githubactions-plain colored" }, // Usando Jenkins como representación de CI/CD
				{
					name: "AWS",
				...
				>
					...
					<div className="mt-4 max-w-3xl mx-auto">
						<p className="text-xl text-gray-500 dark:text-gray-300">
							Herramientas y tecnologías con las que desarrollo
							soluciones
						</p>
					</div>
				</motion.div>
